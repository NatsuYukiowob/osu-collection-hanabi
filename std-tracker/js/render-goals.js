/* Personal goal tracking — ported from catch-tracker's own render-goals.js.
   See netlify/functions/goals.js for the scoped-down (total-pp-only, for
   now) backend this drives. */
