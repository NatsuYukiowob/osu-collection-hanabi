            ...
            <div class="card profile-header${p.cover_url ? ' has-cover' : ''}"${coverStyle}>
                ...
                <div>
                    ...
                    <div class="profile-stats">
                        <a class="pill player-osu-link" href="https://osu.ppy.sh/users/${encodeURIComponent(userId)}/osu" target="_blank" rel="noopener noreferrer">${escapeHtml(t('osu_profile_link'))} ↗</a>
