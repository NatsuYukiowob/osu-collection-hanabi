/* Manual/backfill trigger for the peer best-plays sweep — same core logic
   ...
   plain HTTP, so it requires a shared secret (STD_TRACKER_CRAWL_SECRET
   env var) via the x-std-tracker-secret header, same as
...
const { PEER_CRAWL_PER_RUN_MANUAL } = require('./_std-constants');
