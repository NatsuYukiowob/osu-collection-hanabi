/* Single-player profile: combines the cached rankings:global record (rank/pp
   ...
   Ported from catch-tracker's own player-get.js, minus its rank-delta block
   (that depends on _rank-snapshot-core.js's daily snapshots, which this
   site doesn't build yet — v1 scope; see the memory note on the std tracker
   plan). */
