/* Community-submitted Discord server directory — see
   netlify/functions/communities.js for the backend this drives. */
...
document.getElementById('toggle-submit').addEventListener('click', () => {
    ...
    // text (it keeps its original data-i18n="loading" attribute even
    // after loadCommunities() overwrites its textContent — a real bug
    // caught live-testing this).
