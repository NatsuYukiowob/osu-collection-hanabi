...
// Compact table-cell rank-delta — mania-tracker's rankings table shows a
// plain colour-coded "+N"/"-N" (no arrow glyph, that's reserved for the
// player page's bigger badge — see rankDeltaHtml() in render-player.js),
// "—" when flat/unknown. Title attribute carries the real (non-fixed,
// growing) day count from rankings-list.js rather than the header
// pretending it's always a fixed window.
