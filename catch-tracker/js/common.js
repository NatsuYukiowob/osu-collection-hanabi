...
const LANG_STRINGS = {
    zh: {
        ...
        replay_stat_miss: '漏接',
        replay_stat_hp: 'HP',
        replay_stat_judged: '已判定',
        replay_stat_score: '分數',
        replay_settings: '視覺設定',
        replay_settings_volume: '音量',
        replay_settings_music: '音樂',
        replay_settings_effects: '音效',
        replay_settings_rate: '速度',
        replay_reset_rate: '重置速度',
        replay_settings_offset: '偏移',
        replay_reset_offset: '重置偏移',
        replay_settings_dim: '背景暗度',
        ...
        nav_replays: '回放',
        replays_h1: '觀看回放',
        replays_by_player: '搜尋玩家',
        replays_search_placeholder: '搜尋玩家…',
        replays_by_id: '貼上成績',
        replays_by_id_hint: '貼上一筆成績 ID 或 osu! 成績連結',
        replays_id_placeholder: '例如 https://osu.ppy.sh/scores/123456',
        replays_go: '前往',
        replays_recently_viewed: '最近觀看',
        replays_scores_for: '{name} 的成績',
        replays_none_watchable: '這位玩家目前沒有可觀看的回放。',
        replays_id_invalid: '請輸入有效的成績 ID 或連結。',
        ...
        replays_compare_hint: '同時觀看同一張圖譜、且 AR 相同的兩筆成績（HR/EZ 與 DT(NC)/HT 需一致，其他 mods 不限）。',
        replays_compare_add_a: '選擇成績 A',
        replays_compare_add_b: '選擇成績 B',
        replays_compare_go: '並排觀看',
        replays_compare_mismatch: '兩筆成績必須是同一張圖譜。',
        replays_compare_mods_mismatch: '兩筆成績的 HR/EZ 與 DT(NC)/HT 必須一致 — 這些 mods 會改變 AR 或播放速度，導致水果掉落速度看起來不一樣。其他 mods（如 HD）不受限制。',
        ...
        home_tagline: '追蹤全球 osu!catch 玩家的排名、即時成績與回放。',
        ...
        sort_downloads: '下載次數',
        sort_size: '檔案大小', skins_filter_mine: '我的上傳', skins_filter_has_preview: '有預覽圖',
        skins_by: '由 {name} 上傳',
    ...
    en: {
        ...
        replay_use_skin: 'Upload your osu! skin',
        ...
        replay_stat_hp: 'HP',
        replay_stat_judged: 'Judged',
        replay_stat_score: 'Score',
        replay_settings: 'Visual settings',
        replay_settings_volume: 'Volume',
        replay_settings_music: 'Music',
        replay_settings_effects: 'Effects',
        replay_settings_rate: 'Rate',
        replay_reset_rate: 'Reset rate',
        replay_settings_offset: 'Offset',
        replay_reset_offset: 'Reset offset',
        replay_settings_dim: 'Background Dim',
        ...
        nav_replays: 'Replays',
        replays_h1: 'Watch Replay',
        replays_by_player: 'Search a player',
        replays_search_placeholder: 'Search a player...',
        replays_by_id: 'Paste a score',
        replays_by_id_hint: 'Paste a score ID or an osu! score URL',
        replays_id_placeholder: 'e.g. https://osu.ppy.sh/scores/123456',
        replays_go: 'Go',
        replays_recently_viewed: 'Recently viewed',
        replays_scores_for: "{name}'s scores",
        replays_none_watchable: 'This player has no watchable replays right now.',
        replays_id_invalid: 'Enter a valid score ID or URL.',
        ...
        replays_compare_hint: "Watch two scores on the same beatmap, with the same AR (HR/EZ and DT(NC)/HT must match; other mods are unrestricted).",
        ...
        replays_compare_mods_mismatch: "Both scores' HR/EZ and DT(NC)/HT must match — those mods change AR or playback speed, which makes the fruit fall speed look different between the two sides. Other mods (like HD) aren't restricted.",
        ...
        home_tagline: 'Tracking osu!catch players worldwide — rankings, live scores, and replays.',
        ...
        sort_size: 'Largest file', skins_filter_mine: 'My uploads', skins_filter_has_preview: 'Has preview',
        skins_by: 'by {name}',
