...
const LANG_STRINGS = {
    zh: {
        nav_home: '首頁', nav_rankings: '排行榜', nav_feed: '即時動態', nav_top_plays: '最佳成績',
        loading: '載入中…',
    ...
    en: {
        nav_home: 'Home', nav_rankings: 'Rankings', nav_feed: 'Live Feed', nav_top_plays: 'Top Plays',
        loading: 'Loading…',
        ...
        sort_playcount_desc: 'Most played',
